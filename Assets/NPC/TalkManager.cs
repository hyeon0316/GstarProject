...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(4000 + 40 + 0, new string[] { "어서와! 어서와!","나? 나는 예전에 리치에게 \n도전했다가 패배해서 이렇게 변했지 머람~",
            "너가 촌장님이 말한 친구지!","리치를 잡아야한다고?\n 그럼 내부탁도 들어줘 그럼 방법을 알려줄게!","던전 1번방에가서 고블린을잡고 광기 가득한눈 30개를 모아줘!"});
        ...
        talkData.Add(4000 + 50 + 0, new string[] {"리치한테가는법이 궁금하다고헀지?",
            "리치방에 갈려면 보물방에 있는 \"마력 제어 목걸이\"가 있어야하는데","지금 보물방은 잠겨있어 너가 열쇠랑 재료를 구해와줘","보물방 열쇠 두개로 나눠져있어","던전 2,3번방에서 몬스터를 잡다보면 하나씩나올거야!","아 그리고 잡는김에 던전2,3번방 전리품도 챙겨와줘! 30개씩" });

        talkData.Add(4000 + 50 + 1, new string[] { "아직 다 못구한거같은데?" });
        talkData.Add(4000 + 50 + 2, new string[] { "열쇠조각 다구했구나! 다시말을 걸어줘 금방 보물방을 열어줄게" });
        ...
        talkData.Add(4000 + 70 + 1, new string[] { "드디어 리치를 잡았구나!","고생했어 \"해골 물약\"을 마을 촌장한테 전해주면 촌장이 마력을 전부 회복할꺼야" });
        talkData.Add(7000 + 70 + 2, new string[] { "고생했네 소피아양","재료를 다모았네 잠시만 기달려주게" });
