...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(4000 + 40 + 0, new string[] { "어서와! 어서와!","나? 나는 예전에 리치에게 \n도전했다가 패배해서 이렇게 변했지 머람~",
            "너가 촌장님이 말한 친구지?!","리치를 쓰러트려야 한다고?\n 그럼 내부탁을 들어줘 그럼 방법을 알려줄게!","던전 1번방에가서 고블린을 잡고 광기 가득한 눈 15개를 모아줘!"});
        ...
        talkData.Add(4000 + 50 + 0, new string[] {"리치한테 가는법이 궁금하다고 했지?",
            "리치의 방에 갈려면 보물방에 있는 \"마력 제어 목걸이\"가 있어야하는데","지금 보물방은 잠겨 있어. 너가 열쇠랑 재료를 구해와줘","보물방 열쇠 두개로 나눠져있어","던전 2,3번방에서 몬스터를 잡다보면 하나씩 나올거야!","아 그리고 잡는김에 던전2, 3번방 전리품도 챙겨와줘! 15개씩" });
